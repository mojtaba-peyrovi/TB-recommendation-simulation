        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4" id="single-deal-main">
                    <div class="single-deal-address">
                        ...
                        <span id="single-deal-city-center"><i class="fas fa-map-signs"></i><strong>Estimated_revenue per night:</strong> {{ $hotel->estimated_revenue }}</span><br>
                        <span id="single-deal-city-center"><i class="fas fa-map-signs"></i><strong>Total rank score:</strong> {{ $hotel->rnk }}</span><br>
                    </div>
